...
export const metadata = {
  title: "Airline Domain - Senior Angular developer | Qcentrio Careers",
};
  ...
  return (
    <div className="job-head-section">
      <h1
        ...
        Airline Domain - Senior Angular developer
      </h1>
      <Link href="#apply-now">
      ...
      <table data-option="up" className="animate animate-hidden">
        <tbody>
          ...
          <tr>
            ...
            <td>
              Airline Domain, Frontend Development, HTML5, Angular Developer,
              OOPS concepts, Logging, CSS3, Coding Standards, REST API, Airline
              Process, Angular Airline, Angular Airline Ticketing, Node.js,
              Bootstrap, Exception Handling, Development Airline Project, Ionic,
