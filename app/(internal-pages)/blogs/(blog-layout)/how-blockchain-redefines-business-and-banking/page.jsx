    ...
    <main className="blog-page-content">
      ...
      <div className="blog-page-main-content-container">
        ...
        <div className="blog-page-main-content">
          ...
          <h2>Whims and Fancies – Global Acceptance that Pushed a Digital Revolution</h2>
          <p>
          ...
          <p>
          Blockchain is an open but encrypted ledger database, meaning a block is the live chunk of the blockchain, where the last transaction is recorded. Here is an elucidated applicability of Blockchain, i.e., Bitcoin.</p>
          <ul>
            <li>
            ...
            <li>
              <h3>Hash Encryption: Like that of the Fort Knox, but an Invisible One!</h3>
              <p>
